...
class RecordsTest < ApplicationSystemTestCase
  ...
  test "should create record" do
    ...
    fill_in "Judet spital", with: @record.judet_spital
    fill_in "Localitate spital", with: @record.localitate_spital
    fill_in "Patient", with: @record.patient_id
    fill_in "Sectia", with: @record.sectia
    fill_in "Spital", with: @record.spital
